...
def main():
    ...
    # Input CSVs
    adamp_path = os.path.join(repo_root, "results", "rosmap_methy", "test_mse_adamp_mr.csv")
    hsic_path  = os.path.join(repo_root, "results", "rosmap_methy", "test_mse_hsic.csv")
    lasso_path = os.path.join(repo_root, "results", "rosmap_methy", "test_mse_lasso.csv")

    # Output
    outdir = os.path.join(repo_root, "results", "rosmap_methy")
    os.makedirs(outdir, exist_ok=True)
    outpath = os.path.join(outdir, "rosmap_methy_mse_vs_K.png")
    ...
    ax.set_title("ROSMAP_Methy — Test MSE vs Number of Selected Features", pad=10)
