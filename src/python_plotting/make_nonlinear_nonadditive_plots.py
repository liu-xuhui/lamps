...
title_label = (
    ...
    f"{metric_name_map.get(eval_metd, eval_metd.title())} vs. Interaction SNR "
...
with open(
    f"results/nonlinear/nonadditive/nonlinear_nonadditive_oracle{oracle}_permute{permute}_result_dict.pkl",
    "rb"
) as f:
...
if oracle:
    ...
    figpath = os.path.join(
        outdir,
        f"{eval_metd}_nonadditive_{oracle_str}_{permute_str}_{basemodel}.png"
    )
