...
eval_metd    = "recall"   # "f1_score" | "precision" | "recall"
...
if permute == 0:
    title_label = "Linear Model: Correlated Setting 1"
else:
    title_label = "Linear Model: Correlated Setting 2"
...
for j, rho in enumerate(corr_list):
    ...
    # annotate rho
    ax.text(0.03, 1.02, rf"$\rho = {rho}$", transform=ax.transAxes,
