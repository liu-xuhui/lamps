...
with open(f"result/nonlinear/additive/nonlinear_additive_{oracle_str}_{permute_str}_result_dict.pkl", "rb") as f:
...
if oracle:
    ...
    for j, rho in enumerate(corr_list):
        save_dir = "result/nonlinear/additive"
    ...
    outdir = "result/nonlinear/additive"
    figpath = os.path.join(outdir, f"{eval_metd}_additive_{oracle_str}_{permute_str}.png")
