...
for permute in permute_values:
    hypertuning_folder = f"temp_results/hyperparam_tuning/nonlinear_nonadditive_corr0.5_permute{permute}/best"
    hypertuning_folder_sp = f"temp_results/hyperparam_tuning/nonlinear_sp_nonadditive_corr0.5_permute{permute}/best"
    for oracle in [0]:
