...
for permute in [0,1]:
    for oracle in [1]:
        for corr in corr_list:
            ...
            for snr in snr_list:
                ...
                for rep in range(num_simus):
                    file_path = os.path.join(folder, f"adamlinear_selected_corr{corr}_snr{snr}_permute{permute}_oracle0_rep{rep}.csv")
        ...
        with open(f"results/linear/linear_oracle{oracle}_permute{permute}_result_dict.pkl", "wb") as f:
